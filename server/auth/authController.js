...
function verifyPassword(password, hash) {
  ...
  return keyBuffer.length === derivedKey.length && crypto.timingSafeEqual(derivedKey, keyBuffer);
}
...
async function register(req, res) {
  ...
  try {
    await pool.query(
      ...
      [userId, email.toLowerCase().trim(), hash, name.trim()]
    );
...
module.exports = { guest, register, login, logout, me };
